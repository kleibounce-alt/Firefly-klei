...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
				"/gallery/firefly-2026/221.avif",
			"/gallery/firefly-2026/222.avif",
			"/gallery/firefly-2026/223.avif",
			"/gallery/firefly-2026/224.avif",
			"/gallery/firefly-2026/225.avif",
			"/gallery/firefly-2026/226.avif",
			"/gallery/firefly-2026/227.webp",
			"/gallery/firefly-2026/228.avif",
			"/gallery/firefly-2026/5.avif",
			"/gallery/firefly-2026/116.webp",
			],
		// 移动背景图片（支持单张或多张随机）
	...
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"与君初相识，犹如故人归  --佚名",
				"白日与黑夜永恒地此起彼伏，宛如汪洋大海中的潮汐涨落  --罗曼·罗兰《约翰·克利斯朵夫》",
				"人们的清醒生活，有相当一部分是用来照看自己的脚下  --威廉·戈尔丁《蝇王》",
				"我认为人类至高的荣冠，是美丽的临终  --太宰治《小说灯笼》",
				"由于思想，我却囊括了宇宙  --帕斯卡《思想录》",
				"毕竟，明天又是新的一天了  --玛格丽特·米切尔《飘》",
